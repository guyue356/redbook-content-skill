...
以下是本技能生成的小红书图文示例（主题：KIMI K3 VS Qwen2-Coder）：

| 封面 | 定位 | 架构 |
|:----:|:----:|:----:|
| ![封面](png/01_封面.png) | ![定位](png/02_定位.png) | ![架构](png/03_架构.png) |

| 上下文 | 评测 | 选型 |
|:------:|:----:|:----:|
| ![上下文](png/04_上下文.png) | ![评测](png/05_评测.png) | ![选型](png/06_选型.png) |

> 💡 以上为实际生成效果，每张图均为 1242×1660（3:4）竖版，适配小红书九宫格发布。
...
├── svg_output/        ← SVG 设计稿（01_封面.svg ...）
├── png/               ← 高清 PNG（2484×3320）
